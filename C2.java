...
public class C2 {
		...
		static void run() {
			 ...
			 * 
			 * 
			 * n^1  < n  then its a problem  
			 * 
			 * else n^1 > n then we have a solution 
			 * 
			 * 
			 * if( fist bit of n is not  1) then we have this solution
			 * 
			 * we know n has first bit set 
			 * 
			 * n-1 have first bit not set 
			 * 
			 * (n-1)^1 
			 * 
			 * 
