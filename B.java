...
public class B {
		...
		static void run() {
			/*
			 * if x[0] == '1' || x[1] == '1' then its impossible
			 * 
			 * -ve case 
			 * 
			 * just check for x[i] = '1' if on both sides there exist a range 
			 * 
			 * 
			 * how can i find out the largeest segement i can make 1 if i have to amke x[i] = 1
			 * 
			 * as i have to make to 1 anyways i will choose the largest segment and makeit 1 
			 * 
			 * this wayi will make sure that the solution is most optmial
			 * 
			 * 
			 * 
			 * observe string x
